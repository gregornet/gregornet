...
<!-----------nav html ------------------->
  ...
  <img src="https://pbs.twimg.com/media/Ff3Zs5NXoAA6tgt?format=png&name=small" width="150" height="50" >:octocat:<a href="#home">Home</a>:jack_o_lantern:<a href="#ancla-2">Skills </a> 	:ghost: <a href="#ancla-4">Stats </a>  :computer:
